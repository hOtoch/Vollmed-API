...
class MedicoControllerTest {
    ...
    @Test
    @DisplayName("Deve retornar o codigo http 400 quando informaçoes estao invalidas")
    @WithMockUser
    ...
    @Test
    @DisplayName("Deve retornar o codigo http 200 quando informaçoes estao validas")
    @WithMockUser
    void cadastrar_cenario2() throws Exception {

        var dadosCadastro = new DadosCadastroMedico("Huguinho","hugootoch@hotmail.com","19917182716","123456", Especialidade.CARDIOLOGIA,dadosEndereco());
