...
class ConsultaControllerTest {
    ...
    // Para simular o JSON de entrada do teste http 200
    @Autowired
    private JacksonTester<DadosAgendamentoConsulta> dadosAgendamentoConsultaJson;

    // Para simular o JSON de saida do teste http 200
    @Autowired
    ...
    @Test
    @DisplayName("Deveria retornar codigo http 200 quando informaçoes estao validas")
    @WithMockUser // Simula um usuario logado
